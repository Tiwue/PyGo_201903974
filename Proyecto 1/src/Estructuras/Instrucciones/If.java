...
public class If implements Instruccion {
    ...
    /**
     * Lista de instrucciones que serán ejecutadas si la condición ELSE IF se
     * cumple.
     */
    ...
    /**
     * Segundo constructor de la clase, este se utiliza cuando la instrucción
     * tiene clausula ELSE.
     *
     * @param a Condición del si..entonces
     * @param b Lista de instrucciones que deberían ejecutarse si la condición
    ...
    /**
     * Tercer constructor de la clase, este se utiliza cuando la instrucción
